...
const mapStyleUrl =
  'https://api.maptiler.com/maps/hybrid/style.json?key=n5G7Cjw4uaSGWFAWjABg'
  ...
  render() {
    ...
    return (
      <div>
        ...
        {this.state.initLoaded && this.renderMarkers()}
      </div>
    )
  }
}
...
class LocationArticle extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.isArticleVisible) {
      ...
      chain([delay(200), introScale]).start()
    }
  }
    ...
    return (
      <article className="m-article">
        <div
          ...
          className="m-article__intro"
          style={{
            backgroundImage: `url(${currentArticle.properties.introImage})`,
          }}
        >
          <button
            className="m-article__close"
          ...
          <h1 className="m-article__introTitle">
            {currentArticle.properties.title}
          </h1>
        </div>
      </article>
    )
...
class Marker extends React.Component {
  ...
  renderMarker() {
    ...
    return (
      <div position={feature.geometry.coordinates} key={id}>
        <svg
          className="e-marker"
          version="1.1"
          xmlns="http://www.w3.org/2000/svg"
  ...
  markerEventHandler(marker, feature, map) {
    ...
    const hoverTimeline = timeline([iconScale, imageScale, '-100', textToggle])
  ...
  offSetMarker(marker, markerGrowSize, map) {
    ...
    if (
      ...
      if (windowXSize - markerOffSetX < markerMaxWidth + marker.offsetWidth) {
        offSetX =
          markerMaxWidth + marker.offsetWidth - (windowXSize - markerOffSetX)
      }
  ...
  features: [
    {
      ...
      properties: {
        ...
        introImage:
          'https://c1.staticflickr.com/5/4241/35467523155_25bf8fd39e_h.jpg',
        type: 'beach',
        iconSize: [60, 60],
      },
      geometry: {
    ...
    },
    {
      ...
      properties: {
        ...
        imageUrl:
          'https://c1.staticflickr.com/5/4379/36844732181_78bd19e9eb_q.jpg',
        introImage:
          'https://c1.staticflickr.com/5/4379/36844732181_4704ef4952_h.jpg',
        type: 'beach',
        iconSize: [50, 50],
      },
      geometry: {
        type: 'Point',
        coordinates: [-85.8639766, 11.263406],
      },
    },
    {
      type: 'Feature',
      properties: {
        ...
        imageUrl:
          'https://c1.staticflickr.com/5/4348/36844765631_03e90607bd_q.jpg',
        introImage:
          'https://c1.staticflickr.com/5/4348/36844765631_3e25ac9cd2_h.jpg',
        type: 'beach',
        iconSize: [40, 40],
      },
      geometry: {
        type: 'Point',
        coordinates: [-82.98509939999997, 12.2937504],
      },
    },
    {
      type: 'Feature',
      properties: {
        ...
        title: 'San Salvador',
        imageUrl:
          'https://c1.staticflickr.com/5/4333/36825444362_4291ce6d1e_q.jpg',
        introImage:
          'https://c1.staticflickr.com/5/4333/36825444362_474d38d67c_h.jpg',
        type: 'city',
        iconSize: [40, 40],
      },
      geometry: {
        type: 'Point',
        coordinates: [-89.218191, 13.69294],
      },
    },
    {
      type: 'Feature',
      properties: {
        ...
        title: 'Monteverde',
        imageUrl:
          'https://c1.staticflickr.com/5/4347/36857337771_d1bb7f798a_q.jpg',
        introImage:
          'https://c1.staticflickr.com/5/4347/36857337771_24e5e3f9a0_h.jpg',
        type: 'jungle',
        iconSize: [40, 40],
      },
      geometry: {
        type: 'Point',
        coordinates: [-84.8535067, 10.2855218],
      },
    },
    {
      type: 'Feature',
      properties: {
        ...
        imageUrl:
          'https://c1.staticflickr.com/5/4421/36997408855_bfdb9f1fba_q.jpg',
        introImage:
          'https://c1.staticflickr.com/5/4421/36997408855_2ca0cf2521_h.jpg',
        type: 'mountain',
      },
      geometry: {
        type: 'Point',
        coordinates: [-90.875666, 14.500461],
      },
    },
    {
      type: 'Feature',
      properties: {
        ...
        title: 'Mexico City',
        imageUrl:
          'https://c1.staticflickr.com/5/4388/36837224452_98940aa9e4_q.jpg',
        introImage:
          'https://c1.staticflickr.com/5/4388/36837224452_74d2da5fd2_k.jpg',
        type: 'city',
      },
      geometry: {
        type: 'Point',
    ...
    },
    {
      ...
      properties: {
        ...
        title: 'Oaxaca City',
        imageUrl:
          'https://c1.staticflickr.com/5/4357/36172707494_2b8ea05f04_q.jpg',
        introImage:
          'https://c1.staticflickr.com/5/4357/36172707494_53c0f25d98_h.jpg',
        type: 'city',
      },
      geometry: {
        type: 'Point',
        coordinates: [-96.7216219, 17.0594169],
      },
    },
    {
      type: 'Feature',
      properties: {
        ...
        title: 'Tulum',
        imageUrl:
          'https://c1.staticflickr.com/5/4390/36837410552_fbeb6d1cdc_q.jpg',
        introImage:
          'https://c1.staticflickr.com/5/4390/36837410552_1ec5f5d658_h.jpg',
        type: 'beach',
      },
      geometry: {
        type: 'Point',
        coordinates: [-87.46535019999999, 20.2114185],
      },
    },
  ],
}
...
ReactDOM.render(
  <MapApp geojson={geojson} icons={icons} />,
